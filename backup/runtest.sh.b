...
multi_candidates=1
if [ -f $invfile".inv" ]; then
	multi_candidates=0
fi

inv_prefix=$invfile
if [ $multi_candidates -ne 0 ]; then
	invfile=$invfile"_0"
fi
invfile=$inv_prefix".inv"
...
verfc1=$inv_prefix"_klee1.c"
verfc2=$inv_prefix"_klee2.c"
verfc3=$inv_prefix"_klee3.c"
verfo1=$inv_prefix"_klee1.o"
verfo2=$inv_prefix"_klee2.o"
verfo3=$inv_prefix"_klee3.o"
...
mkdir -p $inv_prefix"_klee1" $inv_prefix"_klee2" $inv_prefix"_klee3"
mv $verfc1 $inv_prefix"_klee1"
mv $verfc2 $inv_prefix"_klee2"
mv $verfc3 $inv_prefix"_klee3"


cd $inv_prefix"_klee1" 
rm -rf klee-*
rm -rf *.smt2
