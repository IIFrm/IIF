...
sometimes we can not get solution between given scope we try 10 times, if still no suitable solution, we pick the last one...\index{Equation@{Equation}!multi\+\_\+imply@{multi\+\_\+imply}}
\index{multi\+\_\+imply@{multi\+\_\+imply}!Equation@{Equation}}
\subsubsection[{multi\+\_\+imply(const Equation $\ast$e1, int e1\+\_\+num, const Equation \&e2)}]{\setlength{\rightskip}{0pt plus 5cm}bool Equation\+::multi\+\_\+imply (
\begin{DoxyParamCaption}
\item[{const {\bf Equation} $\ast$}]{e1, }
\item[{int}]{e1\+\_\+num, }
\item[{const {\bf Equation} \&}]{e2}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [static]}}\hypertarget{classEquation_a1a53efa4ba6e185558de78f1065ab375}{}\label{classEquation_a1a53efa4ba6e185558de78f1065ab375}
...
int 0 if no error. 
\end{DoxyReturn}
\index{Equation@{Equation}!to\+\_\+z3expr@{to\+\_\+z3expr}}
\index{to\+\_\+z3expr@{to\+\_\+z3expr}!Equation@{Equation}}
\subsubsection[{to\+\_\+z3expr(char $\ast$$\ast$name, z3\+::context \&c) const }]{\setlength{\rightskip}{0pt plus 5cm}z3\+::expr Equation\+::to\+\_\+z3expr (
\begin{DoxyParamCaption}
\item[{char $\ast$$\ast$}]{name, }
\item[{z3\+::context \&}]{c}
\end{DoxyParamCaption}
) const}\hypertarget{classEquation_a7d0317b67dd6ae784f5792363a242568}{}\label{classEquation_a7d0317b67dd6ae784f5792363a242568}


This method converts $\ast$this equation object to z3 expr object. 

Introducing this method help to simplify imlementation of imply method.


\begin{DoxyParams}{Parameters}
{\em name} & contains each variants names. If N\+U\+LL, the name would be \char`\"{}x\+\_\+1\char`\"{}, \char`\"{}x\+\_\+2\char`\"{} form. \\
\hline
{\em c} & is z3\+::context, defines which context the return expr will be used. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
z3\+::expr 
