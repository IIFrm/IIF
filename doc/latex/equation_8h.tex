...
\begin{DoxyCompactList}\small\item\em This class defines an equation by storeing all its coefficiencies. An equation is regarded a hyperplane in math. \end{DoxyCompactList}\end{DoxyCompactItemize}
